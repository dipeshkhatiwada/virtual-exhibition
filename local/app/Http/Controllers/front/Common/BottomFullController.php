...
class BottomFullController extends Controller
{
    ...
    {
        $datas = \App\Module::getModules($layout_id, 'bottom_full_width');
        $modules = array();
        ...
        return view('front.common.bottomFullwidth')->with('datas', $modules);
