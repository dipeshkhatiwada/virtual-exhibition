...
public function index($id,$setting)
    {
        ...
        $datas['blogs'] = [];
        $blogs = EmployerBlog::where('category',$setting->category)->where('status', 1)->orderBy('visits','desc')->limit($setting->per_page)->get();
        ...
        return view('front.module.popularblog')->with('datas', $datas);
