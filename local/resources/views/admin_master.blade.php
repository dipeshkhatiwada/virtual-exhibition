            ...
            <li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('/admin/training_category') }}"><i class="fa fa-life-bouy"></i> Training Category</a></li>
                <li><a href="{{ url('/admin/training') }}"><i class="fa fa-life-bouy"></i> Trainings</a></li>
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('/admin/event_category') }}"><i class="fa fa-life-bouy"></i> Event Category</a></li>
                <li><a href="{{ url('/admin/event') }}"><i class="fa fa-life-bouy"></i> Events</a></li>
              </ul>
             </li>
             ...
             <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('enroll.add')}}"><i class="fa fa-life-bouy"></i>Register Exhibition</a></li>
                    <li><a href="{{route('enroll.index')}}"><i class="fa fa-life-bouy"></i>Exhibition Details</a></li>
                    <li><a href="{{route('booth.create')}}"><i class="fa fa-life-bouy"></i>Register Booth</a></li>
                    <li><a href="{{route('enroll_booth.detail')}}"><i class="fa fa-life-bouy"></i>Booth Details</a></li>
                    <li><a href="{{route('enroll_reservation.detail')}}"><i class="fa fa-life-bouy"></i>Reservation Details</a></li>
                    <li><a href="{{url('admin/enroll/invoice')}}"><i class="fa fa-files-o"></i>Enroll Invoice</a></li>
                </ul>
               </li>
