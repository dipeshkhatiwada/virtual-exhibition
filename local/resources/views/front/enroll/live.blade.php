    ...
    <div class="container rn_container">
        <div class="row">
            <aside class="col-lg-3 col-md-4 col-12">
                <h2 align="center"><input type="text" id="viewerCount" style="align-items: center; border:hidden; width:100px" value="{{ 0 }}"></h2>
...
<input type="hidden" id="c_slug" value="{{ $datas['enroll']->seo_url }}">
<input type="hidden" id="join-channel" value="{{ $datas['channel'] }}">
