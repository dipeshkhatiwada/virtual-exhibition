    ...
    <div class="row cm-row">
      ...
      <div class="col-md-3 col-9">
          <div class="float-right loginbtns tp14p">
            ...
            <a href="{{url('/employee/dashboard')}}" title="Dashboard" target="_blank"><span class="user-image" style="margin-top: -10px;"><img src="{{asset(\App\Employees::getPhoto(Auth::guard('employee')->user()->id))}}"></span><span > <strong>{{\App\Employees::getName(Auth::guard('employee')->user()->id)}}</strong></span></a>
