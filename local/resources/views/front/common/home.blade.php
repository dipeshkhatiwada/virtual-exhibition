    ...
    <div class="row cm10-row">
      ...
      <div class="col-lg-4 hidden-md hidden-xs">
         <div class="float-right loginbtns tp2m">
            ...
            <a href="{{url('/employee/dashboard')}}" title="Dashboard" target="_blank"><span class="user-image"><img src="{{asset(\App\Employees::getPhoto(Auth::guard('employee')->user()->id))}}"></span><span > <strong>{{\App\Employees::getName(Auth::guard('employee')->user()->id)}}</strong></span></a>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="topmenu">
          <ul>
              <li><a class="nav-item nav-link active" href="{{url('/women')}}" target="blank">Rolling Women</a></li>
              <li><a class="nav-item nav-link" href="{{url('/able')}}" target="blank">Rolling Able</a></li>
              <li><a class="nav-item nav-link" href="{{url('/retired')}}" target="blank">Rolling Yet to Retire</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<section class="hidden-lg hidden-md">
    <div class="">
      <div class="row cm10-row">
        <div class="col-4">
            <div class="mainlogo tb5p"><a href="{{url('/')}}"><img src="{{ \App\library\Settings::getLogo() }}"></a></div>
        </div>
        <div class="col-8">
    ...
    <div class="container rn_container">
        <div class="row cm-row hidden-xs">
            <div class="col-md-2 col-sm-2">
                <div class="mainlogo hidden-xs"><a href="{{url('/')}}"><img src="{{ \App\library\Settings::getLogo() }}"></a></div>
            </div>
            ...
            <div class="float-right loginbtns tp10p">
              ...
              @elseif(isset(Auth::guard('employee')->user()->firstname))
             <a href="{{url('/employee/dashboard')}}" title="Dashboard" target="_blank"><span class="user-image"><img src="{{asset(\App\Employees::getPhoto(Auth::guard('employee')->user()->id))}}"></span><span class="hidden-xs"> <strong>{{\App\Employees::getName(Auth::guard('employee')->user()->id)}}</strong></span></a>
                <a class="btn" href="{{url('/employee/logout')}}" title="Logout"><i class="fa fa-power-off"></i><span class="hidden-xs"> Logout</span></a>
              @else
              <button type="button" class="btn individualbtn bluebtn" data-toggle="modal" data-target="#individualModal" data-whatever="@mdo"><span class="hidden-xs">Individual</span></button>
              <button type="button" class="btn businessbtn greenbtn" data-toggle="modal" data-target="#businessModal" data-whatever="@mdo"><span class="hidden-xs">Business</span></button>
    ...
    <div class="container rn_container">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6 float-left hidden-xs hidden-md">
                ...
                <!--  <img src="{{asset('images/nexusinfo.png')}}" alt="rollingnexuslogo"> -->
                <div id="infographic">
            <div class="rjobs">
              <img src="{{asset('images/nexus_info/logo_red.png')}}">
            </div>
            <div class="rtenders">
              <img src="{{asset('images/nexus_info/logo_green.png')}}">
            </div>
            <div class="rprojects">
              <img src="{{asset('images/nexus_info/logo_orange.png')}}">
            </div>
            <div class="rtests">
              <img src="{{asset('images/nexus_info/logo_bluedark.png')}}">
            </div>
            <div class="rtrainings">
              <img src="{{asset('images/nexus_info/logo_blue.png')}}">
            </div>
            <div class="revents">
              <img src="{{asset('images/nexus_info/logo_grey.png')}}">
            </div>  
            <div class="circle">
              <img src="{{asset('images/nexus_info/circle.png')}}">
            </div>
            <div class="nexuslogo" data-aos="fade-in" data-aos-delay="400">
              <a href="#"><img src="{{asset('images/nexus_info/rnlogo.png')}}"></a>
            </div>
          </div>  
                </div>
                <div  id="set-8" class="nexusmenu">
                    <ul class="hi-icon-wrap hi-icon-effect-8">
                        <li data-aos="fade-up" data-aos-delay="600"><a href="#job" class="hi-icon"><img src="{{asset('images/job.png')}}"></a></li>
                        <li data-aos="fade-up" data-aos-delay="1000"><a href="#tender" class="hi-icon"><img src="{{asset('images/tender.png')}}"></a></li>
                        <li data-aos="fade-up" data-aos-delay="1400"><a href="#project" class="hi-icon"><img src="{{asset('images/project.png')}}"></a></li>
                        <li data-aos="fade-up" data-aos-delay="1800"><a href="#test" class="hi-icon"><img src="{{asset('images/test.png')}}"></a></li>
                        <li data-aos="fade-up" data-aos-delay="2200"><a href="#training" class="hi-icon"><img src="{{asset('images/training.png')}}"></a></li>
                        <li data-aos="fade-up" data-aos-delay="2600"><a href="#event" class="hi-icon"><img src="{{asset('images/event.png')}}"></a></li>
                    </ul>
                </div>
            </div>
        </div>
