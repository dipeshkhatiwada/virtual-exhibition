                                            ...
                                            <div class="modal-body">
                                                <form method="post" id="employee-login-form" action="{{url('/employee/login')}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="float-right ind_forget"><a href="{{ url('employee/password') }}">Forgot your Password ?</a></span>
                                                    </div>  
                                                </form>
                                            </div>
  ...
  <div class="modal fade" id="businessModal" tabindex="-1" role="dialog" aria-labelledby="businessModalLabel" aria-hidden="true">
                                    <div class="modal-dialog business_form" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="employer-login-form" method="POST" action="{{ url('/employer/login') }}">
                                                    {!! csrf_field() !!}
                                                    <div class="form-group row cm-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="float-right busi_forget"><a href="{{ url('employer/password') }}">Forgot your Password ?</a></span>
                                                    </div>  
                                                </form>
                                            </div>
                                            <div class="modal_footer">
                                                <p>If you don’t have an account, please create an account.</p>
                                                <div class="tb10m">
                                                    <a href="{{url('/employer/register')}}" class="btn busi_signupbtn" >Sign Up</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
