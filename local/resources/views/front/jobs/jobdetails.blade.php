          ...
          <div class="col-lg-4 col-md-4 center">
            <div class="employer_logoframe">
              <div class="employer_logo">
                  ...
                  <a href="{{url('/'.$datas['employer_url'])}}"><img src="{{$datas['employer_logo']}}"></a>
                @else
...
The assessments vary depending of the specific function, however it will often start with a technical assessment/s followed by a competency based interview.</div>
          ...
          <div class="recommendation tp20p">
            <button class="large_bluebtn" data-toggle="modal" data-target="#recomendModal">Recommend to your friend</button>
      ...
      <!-- employer job list section started here -->
      ...
      <!-- employer job list section ended here -->
    </div>
  </div>
</section>
<script type="text/javascript">
