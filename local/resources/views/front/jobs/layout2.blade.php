...
<section class="brand_banner brand_banner2 tp60p" style="<?php echo $style;?>">
   @if($datas['employer_logo'] != '')
    <div class="brand_logo brand_logo2">
    ...
    <div class="notice2">
      <div class="notice-content">
        <h2 class="notice2_hd">NOTICE</h2>
        <div class="vticker">
          <ul>
            @foreach($datas['notice'] as $notice)
                @php($dt = \Carbon\Carbon::parse($notice->date))
            <li><div class="notice noticeborder">
              <div class="row cm10-row">
                <div class="col-lg-3 col-md-3 col-3">
                  <div class="n_date">
                    <span class="day bold brandcolor">{{$dt->day}}</span><br>
                    <p>{{$dt->formatLocalized('%b')}}, {{$dt->year}}</p>
                  </div>
                </div>
...
<section>
    ...
    <div class="brand_menu greybg position">
      <div class="container">
        <div class="row cm-row">
          <div class="col-lg-10 col-md-9 col-4">
        <nav class="navbar navbar-expand-sm brandmenu brandmenu2 stick-top">
