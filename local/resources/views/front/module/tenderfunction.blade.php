...
<div class="row cm10-row">
  ...
  <div class="col-md-4">
    <div class="tender_block center">
      ...
      <p class="company_tenders tp20p text-ellipsis"><a href="{{$tender['employer_url']}}" >{{$tender['employer']}}</a></p>
      <p class="btm10p text-ellipsis"><a href="{{$tender['href']}}" >{{$tender['title']}}</a></p>
