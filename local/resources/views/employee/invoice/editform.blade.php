...
<p class="lead">Add History:</p>
            <form class="dash_forms" enctype="multipart/form-data" role="form" id="testform" method="POST" action="{{ url('/employee/invoice/add-history') }}">
              {!! csrf_field() !!}
            ...
            <div class="row no-print">
              <div class="col-12">
                <a href="{{url('employee/invoice/print/'.$data['invoice']->id)}}" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
              </div>
            </div>
          </div>
@endsection
