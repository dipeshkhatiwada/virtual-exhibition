        ...
        <div class="row cm-row">
            <div class="col-md-5 col-12 hidden-xs">
                <div class="login_info">
                    ...
                    <div class="center tp20p"><a href="{{url('/employee/register')}}" class="btn signupbtn ind_signup">Sign up</a></div>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ url('/employee/login') }}">
                        ...
                        <div class="form-group row cm-row">
                            ...
                            <div class="col-md-9">
                              ...
                              <span class="forget"><a href="{{ url('employee/password') }}">Forgot Password ?</a></span>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-md-5 col-12 hidden-lg hidden-md">
                <div class="login_info">
                    ...
                    <div class="center tp20p"><a href="{{url('/employee/register')}}" class="btn signupbtn individual-signup">Sign up</a></div>
                </div>
            </div>
        </div>
    </div>
