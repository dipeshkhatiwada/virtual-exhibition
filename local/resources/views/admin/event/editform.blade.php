        ...
        <div class="box">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="dash_forms" role="form" enctype="multipart/form-data" id="testform" method="POST" action="{{url('/admin/event/update')}}">
                                    ...
                                    <div class="tab-pane active" id="mainevent">
                                        <div class="form-group row ">
                                            <div class="col-md-4 {{ $errors->has('employer') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control" id="emp" name="emp" value="{{ \App\Employers::getName($datas['mainevent']->employers_id) }}">
                                                <input type="hidden" name="employer" id="employer" value="{{$datas['mainevent']->employers_id}}">
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-6 {{ $errors->has('latitute') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" id="latitute" name="latitute" class="form-control"  value="{{ $datas['mainevent']->latitute }}">
                                            ...
                                            <div class="col-md-6 {{ $errors->has('longitute') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" id="longitute" name="longitute" class="form-control"  value="{{ $datas['mainevent']->longitute }}">
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="from-group row">
                                                ...
                                                <input type="text"  id="start_time" name="start_time" class="form-control timepicker" value="{{ $datas['mainevent']->start_time }}">
                                            ...
                                            <div class="col-md-4 {{ $errors->has('end_time') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text"  id="end_time" name="end_time" class="form-control timepicker" value="{{ $datas['mainevent']->end_time }}">
                                            ...
                                            <table class="table table_form table-hover">
                                                ...
                                                <tbody id="event_photo">
                                                    ...
                                                    <tr id="photo_{{$key}}">
                                                        ...
                                                        <td><button type="button" onclick="$('#photo_{{$key}}').remove();" data-toggle="tooltip" title="remove" class="btn whitegradient"><i class="fa fa-minus-circle"></i> Remove</button></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                                <tfoot>
                                            ...
                                            <table class="table table_form table-hover">
                                                ...
                                                <tbody id="event_sponsor">
                                                    ...
                                                    <tr id="sponsor_{{$key}}">
                                                        ...
                                                        <td><button type="button" onclick="$('#sponsor_{{$key}}').remove();" data-toggle="tooltip" title="remove" class="btn whitegradient"><i class="fa fa-minus-circle"></i> Remove</button></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                                <tfoot>
