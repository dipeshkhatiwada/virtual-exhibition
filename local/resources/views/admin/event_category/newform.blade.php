...
@section('breadcrubm')
 <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="{{ url('/admin/event_category') }}">Event Categorys</a></li>
        ...
        <div class="box">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="{{ url('/admin/event_category/save') }}">
                        {!! csrf_field() !!}
                        <div class="row">
                         <div class="col-md-10">
