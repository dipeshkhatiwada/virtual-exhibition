...
@section('heading')
New Training
<small>Detail of New Training</small>
@stop
@section('breadcrubm')
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="panel panel-default">
                <div class="panel-heading">New Training</div>
                <div class="panel-body">
                    <form class="dash_forms" role="form" enctype="multipart/form-data" id="testform" method="POST" action="{{url('/admin/training/save')}}">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row ">
                                    <div class="col-md-6 {{ $errors->has('latitude') ? ' has-error' : '' }}">
                                        <label class="required">Latidude</label>
