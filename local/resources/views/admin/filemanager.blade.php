<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo $datas['heading_title']; ?></h4>
    </div>
    <div class="modal-body">
      <div class="row">
        <div class="col-sm-7"><a href="<?php echo $datas['parent']; ?>" data-toggle="tooltip" title="" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $datas['refresh']; ?>" data-toggle="tooltip" title="" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
          <button type="button" data-toggle="tooltip" title="" id="button-upload" class="btn btn-primary"><i class="fa fa-upload"></i></button>
          <button type="button" data-toggle="tooltip" title="" id="button-folder" class="btn btn-default"><i class="fa fa-folder"></i></button>
