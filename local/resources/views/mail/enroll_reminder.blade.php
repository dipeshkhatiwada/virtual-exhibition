...
<div class="Application">
    <div class="AppLeft"> <img src="{{asset('rollingnexus/image/'.$data['logo'])}}" height="75px" width="224">
        <div class="thinLine"> </div>
        <div class="salutation" >
            <p id="lin"> Dear, {{ $data['to_name']}} </p>
        </div>   <!-- start/end of links-->
        <div class="message" >
             <p id="lin2">We are pleased to inform you about the upcoming exhibition scheduled for {{ Carbon\Carbon::parse($data['reserve']->start_date)->toFormattedDateString('d-m-Y') }}.
    ...
    <div class="AppRight" >
        ...
        <div class="ronnie"> <img src="{{ asset('rollingnexus/images/ronnie.png') }}" height="100px"> </div>
        <div class="eventLogo"> <img src="{{ asset('rollingnexus/images/event.png') }}" height="100px"> </div>
    </div>
