...
<div style="width: 680px;"><img src="{{asset('image/'.$data['logo'])}}" alt="<?php echo $data['from_name']; ?>" style="margin-bottom: 20px; border: none; max-height:100px;" /></a>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;">Your Order ({{$data['order_id']}}) status has been changed as {{$data['status']}}</p>
  
  <p style="margin-top: 0px; margin-bottom: 20px;">{{$data['comment']}}</p>
