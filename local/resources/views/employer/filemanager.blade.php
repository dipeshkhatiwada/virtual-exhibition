...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload #file').val() != '') {
			...
			$.ajax({
				url: '{{ url("/employer/filemanager/upload/") }}?directory=<?php echo $datas['directory']; ?>',
				type: 'post',
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		...
		$.ajax({
			url: '{{ url("/employer/filemanager/folder/") }}?directory=<?php echo $datas['directory']; ?>',
			type: 'post',
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('Do you Want to delete This?')) {
		...
		if (users != '') {
		$.ajax({
			url: '{{ url("/employer/filemanager/delete/?") }}',
			type: 'get',
			dataType: 'json',
			data: 'path='+ users,
			beforeSend: function() {
...
$('#modal-image #button-select').on('click', function(e) {
		...
		if (users != '') {
		$.ajax({
			url: '{{ url("/employer/filemanager/select_multiple/?") }}',
			type: 'get',
			dataType: 'json',
			data: 'path='+ users,
			beforeSend: function() {
