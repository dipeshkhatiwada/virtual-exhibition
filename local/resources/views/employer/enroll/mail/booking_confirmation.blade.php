...
<head>
    ...
    <style type="text/css">
        *{margin:0px; padding:0px ; box-sizing:border-box; }
        ...
        .regards{width:750px; height:36px;  position:absolute ; top:200px; font-size:15px; font-family: Montserrat SemiBold; color: #000000; }
...
<div class="Application">
    <div class="AppLeft"> <img src="{{asset('image/'.$data['logo'])}}" height="75px" width="224">
        <div class="thinLine"> </div>
        <div class="salutation" >
            <p id="lin"> Dear, {{ $data['to_name']}} </p>
        </div>   <!-- start/end of links-->
        <div class="message" >
             <p id="lin2"> {{ $data['text'] }}</p>
        </div>   <!-- start/end of links-->
        <div class="regards" >
            <p id="lin2"> Regards,  </p>
    ...
    <div class="AppRight" >
        ...
        <div class="ronnie"> <img src="{{ asset('images/ronnie.png') }}" height="100px"> </div>
        <div class="eventLogo"> <img src="{{ asset('images/event.png') }}" height="100px"> </div>
    </div>
