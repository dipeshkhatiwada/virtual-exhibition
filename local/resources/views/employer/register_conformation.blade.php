  ...
  <div style="width: 40%; position: relative; margin:50px auto; background-color:#f6f8fa; border-radius:3px 3px 0px 0px; box-shadow:0px 2px 4px rgba(0,0,0,.25);">
    ...
    <div style="width:94%; padding:0% 3%;">
      ...
      <div style="text-align:center; padding:20px 0px;">
        <a href="{{url('/employer/validate-email?email='.$data['email'].'&token='.$data['token'])}}" style="background-color:#008bb5; padding:7px 35px; text-decoration:none; color:#fff; border-radius:3px 3px 3px 3px; font-size:14px;">Verify Email</a>
      </div>
