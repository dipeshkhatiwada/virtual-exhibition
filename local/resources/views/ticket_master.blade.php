  ...
  <body class="hold-transition skin-blue sidebar-mini ">
    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span >{{ Auth::guard('ticket')->user()->name }}</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="user-footer">
                    <div class="pull-right">
                      <a class="dropdown-item" href="{{ url('/tickets/logout') }}"
                        onclick="event.preventDefault();
                          document.getElementById('logout-form').submit();">
                          Logout
                      </a>
                      <form id="logout-form" action="{{ url('/tickets/logout') }}" method="POST" style="display: none;">
                          {!! csrf_field() !!}
                      </form>
                    </div>
                  </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <li>
              <a href="{{ url('/tickets/changepassword') }}">
                <i class="fa fa-users"></i> <span>Change Password</span>
              </a>
            </li>
            <li>
              <a href="{{ url('/tickets/tickets') }}">
                <i class="fa fa-reorder"></i> <span>Tickets</span>
              </a>
            </li>
            <li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-{{date('Y')}} <a target="_blank" href="http://www.rollingnexus.com">Rolling Nexus</a>.</strong> All rights reserved.
      </footer>
