<html lang="en">
        ...
        <div class="container-fluid p-0">
            <div id="main-container">
                ...
                <div id="full-screen-video">
                    <a-scene>
                        <a-assets>
                            <a-asset-item id="broadcaster" src=""></a-asset-item>
                        </a-assets>
    ...
    <script src="<?php echo e(asset('js/agora_test/js/webvr-broadcast-client.js')); ?>" type="text/javascript"></script>
</html>
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/enroll/brod.blade.php ENDPATH**/ ?>