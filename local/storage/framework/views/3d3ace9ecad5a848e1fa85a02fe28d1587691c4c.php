  ...
  <div style="width: 40%; position: relative; margin:50px auto; background-color:#f6f8fa; border-radius:3px 3px 0px 0px; box-shadow:0px 2px 4px rgba(0,0,0,.25);">
    <div style="border-bottom:1px solid #e8e8e8; float:left; position:relative; width:98%; background-color:#f4f4f4; padding:1% 1% 0% 1%; border:3px 3px 0px 0px;">
      ...
      <div style="width:50%; float:right; position: relative; text-align:right;">
        <img src="<?php echo e(asset('image/nexus_logo.png')); ?>" style="margin-top:5px; margin-right:5px;">
      </div>
    </div>
    <div style="clear:both;"></div>
    <div style="width:94%; padding:0% 3%;">
      <h4 style="color:#008bb5; font-size:14px; font-weight:500; padding-top:0px; margin:15px 0px 10px 0px;">Dear <?php echo e($data['name']); ?>,</h4>
      ...
      <div style="text-align:center; padding:20px 0px;">
        <a href="<?php echo e(url('/employer/validate-email?email='.$data['email'].'&token='.$data['token'])); ?>" style="background-color:#008bb5; padding:7px 35px; text-decoration:none; color:#fff; border-radius:3px 3px 3px 3px; font-size:14px;">Verify Email</a>
      </div>
      ...
      <ul style="font-size:12px; color:#555;">
        <li>Right click on the 'Create a new password' link. Select 'Verify Email' & paste the URL in the address bar.</li>
      </ul>
...
</html><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/register_conformation.blade.php ENDPATH**/ ?>