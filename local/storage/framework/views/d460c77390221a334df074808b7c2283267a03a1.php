        ...
        <div class="box">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="dash_forms" role="form" enctype="multipart/form-data" id="testform" method="POST" action="<?php echo e(url('/admin/event/save')); ?>">
                                    ...
                                    <div class="tab-pane active" id="mainevent">
                                        <div class="form-group row ">
                                            ...
                                            <label class="required">Employer</label>
                                                <input type="text" class="form-control" id="emp" name="emp" value="<?php echo e(old('emp')); ?>">
                                                <input type="hidden" name="employer" id="employer" value="<?php echo e(old('employer')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/admin/event/newform.blade.php ENDPATH**/ ?>