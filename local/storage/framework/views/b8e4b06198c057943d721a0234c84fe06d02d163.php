...
<script type="text/javascript" src="<?php echo e(asset('assets/plugins/timepicker/bootstrap-timepicker.min.js')); ?>"></script>
      <h3 class="form_heading">New Training</h3>
        ...
        <form class="dash_forms" enctype="multipart/form-data" role="form" id="testform" method="POST" action="<?php echo e(url('/employer/training/save')); ?>">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group row ">
            <div class="col-md-6 <?php echo e($errors->has('training_category') ? ' has-error' : ''); ?>">
                 ...
                 <select class="form-control" name="training_category">
                   ...
                   <?php if($category->id == old('training_category')): ?>
          ...
          <div class="form-group row ">
            <div class="col-md-6 <?php echo e($errors->has('latitude') ? ' has-error' : ''); ?>">
              ...
              <input type="text" id="latitude" name="latitude" class="form-control"  value="<?php echo e(old('latitude')); ?>">
             ...
             <div class="col-md-6 <?php echo e($errors->has('longitude') ? ' has-error' : ''); ?>">
              ...
              <input type="text" id="longitude" name="longitude" class="form-control"  value="<?php echo e(old('longitude')); ?>">
          ...
          <div class="form-group row ">
            <div class="col-md-6 <?php echo e($errors->has('start_date') ? ' has-error' : ''); ?>">
              ...
              <input type="text"  id="start_date" name="start_date" class="form-control datepicker" value="<?php echo e(old('start_date')); ?>">
          ...
          <div class="form-group row ">
            ...
            <div class="col-md-6 <?php echo e($errors->has('end_date') ? ' has-error' : ''); ?>">
              ...
              <input type="text"  id="end_date" name="end_date" class="form-control datepicker" value="<?php echo e(old('end_date')); ?>">
           ...
           <div class="form-group row">
            <div class="col-md-6 <?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
              ...
              <input type="text" id="address" name="price" class="form-control"  value="<?php echo e(old('price')); ?>">
            ...
            <div class="col-md-6 <?php echo e($errors->has('image') ? ' has-error' : ''); ?>">
              ...
              <input type="hidden" name="image" value="<?php echo e(old('image')); ?>" id="input-thumb" />
...
<?php echo $__env->make('employer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/training/addnew.blade.php ENDPATH**/ ?>