                        ...
                        <div class="next">
                          <div class="row cm-row">
                            <div class="col-md-3 col-lg-3 col-3">
                              <div class="complogo">
                                  <?php if($job['logo'] != ''): ?>
                                <a href="<?php echo e($job['url']); ?>"><img src="<?php echo e(asset($job['logo'])); ?>"></a>
                                <?php else: ?>
                                <div class="noimage_sqr backgroundcolor-<?php echo e($job['fletter']); ?>"><?php echo e($job['fn']); ?></div>
                                <?php endif; ?>
                              </div>
                            </div>
                            <div class="col-md-9 col-lg-9 col-9 job-list text-ellipsis">
                              <div class="lft10p">
                              <a class="company_name" title="<?php echo e($job['employer_name']); ?>" href="<?php echo e($job['url']); ?>"><?php echo e($job['employer_name']); ?></a>
                              <ul class="joblist">

                                <?php $__currentLoopData = $job['jobs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ejob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="text-ellipsis"><a title="<?php echo e($ejob->title); ?>" href="<?php echo e(url('/jobs/'.$job['seo_url'].'/'.$ejob->seo_url)); ?>"><?php echo e($ejob->title); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </ul>
                            </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.job-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/front/jobs/category_jobs.blade.php ENDPATH**/ ?>