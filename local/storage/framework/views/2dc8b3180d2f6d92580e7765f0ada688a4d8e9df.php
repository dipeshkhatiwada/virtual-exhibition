        ...
        <section class="wrapper" style="width:900px; background-color: #fefefe; border:1px solid #f3f3f3; padding:10px; float:left;">
            ...
            <div style="margin-bottom: 10px; width: 100%; float: left;">
                ...
                <div style="float: right;  right:0px; padding:0px;">
                    Bill To
                    <div>
                        <strong><?php echo e($data['invoice_detail']->customer_name); ?></strong><br>

                        Phone: <?php echo e($data['invoice_detail']->telephone); ?><br>
            ...
            <div style="width: 100%; float: left; margin-top: 30px; border:1px solid #f3f3f3;">
                <table style="width: 100%;">
                    ...
                    <tbody>
                        <?php ($i = 1); ?>
                        <?php $__currentLoopData = $data['invoice_detail']->invoiceItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="padding:5px;"><?php echo e($i++); ?></td>
                                <td style="padding:5px;"><?php echo e($item->name); ?></td>
                                <!-- <td style="padding:5px;"><?php echo e($item->product_type); ?></td> -->
                                <td style="padding:5px;"><?php echo e($item->duration); ?> <?php echo e($item->type == 'MemberUpgrade' ? 'Month(s)' : 'Day(s)'); ?></td>
                                <td style="padding:5px;">Rs. <?php echo e($item->amount); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr style="font-weight: bold;">
                                <td colspan="3" style="text-align: right; padding-right: 10px; font-weight: 700">Total Amount</td>
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/mail/job_invoice.blade.php ENDPATH**/ ?>