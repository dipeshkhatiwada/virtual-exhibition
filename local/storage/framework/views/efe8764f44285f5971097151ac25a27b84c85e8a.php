<html lang="en">
  ...
  <body>
  <input type="text" id="join-channel" value="<?php echo e($data['channel']); ?>">
  <input type="hidden" id="pusher_key" value="<?php echo e(env('PUSHER_APP_KEY')); ?>">

    <div class="container">
        <h2 align="center"><input type="text" id="viewerCount" style="align-items: center;" value="<?php echo e(0); ?>"></h2>
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/front/enroll/audience.blade.php ENDPATH**/ ?>