...
<div class="Application">
    <div class="AppLeft"> <img src="<?php echo e(asset('image/'.$data['logo'])); ?>" height="75px" width="224">
        ...
        <div class="message" >
             <p id="lin2"> <?php echo e($data['text']); ?></p>
        </div>   <!-- start/end of links-->
        <div class="regards" >
            <p id="lin2"> Regards,  </p>
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/enroll/mail/booking_confirmation.blade.php ENDPATH**/ ?>