<header class="header tb10p showheader"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <div class="container rn_container">
    <div class="row cm-row">
      <div class="col-lg-2 col-md-2 col-3 inner_logo hidden-xs">
        <a href="<?php echo e(url('/women')); ?>"><img src="<?php echo e(\App\library\Settings::getWomenLogo()); ?>"></a>
      </div>
        ...
        <div class="float-right loginbtns tp12p">
          <?php if(isset(Auth::guard('employer')->user()->name)): ?>
           <a href="<?php echo e(url('/employer/dashboard')); ?>" target="_blank" title="<?php echo e(\App\Employers::getName(Auth::guard('employer')->user()->employers_id)); ?>"><span class="user-image"><img src="<?php echo e(asset(\App\Employers::getPhoto(Auth::guard('employer')->user()->employers_id))); ?>"></span><span class="hidden-xs"><strong> Dashboard</strong></span></a>
            <a class="ipadloginbtns" href="<?php echo e(url('/employer/logout')); ?>" target="_blank"><i class="fa fa-power-off"></i><span class="hidden-xs"> Logout</span></a>
...
</header><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/front/common/women_header.blade.php ENDPATH**/ ?>