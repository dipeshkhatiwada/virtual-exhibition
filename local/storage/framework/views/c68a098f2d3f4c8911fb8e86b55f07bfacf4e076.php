...
<head>
    ...
    <link href="<?php echo e(asset('css/style_mdb.css')); ?>" rel="stylesheet">
            ...
            <div class="row">
                ...
                <div class="col-3">
                        <ul class="navbar-nav mr-auto smooth-scroll">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e($company_detail->company_website); ?>" target="_blank" data-offset="90">Company Website</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#profile" data-offset="90">Company Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('enroll.audience', $company_detail->seo_url)); ?>" data-offset="90">Watch LiveStream</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(url('/enroll/group-video/joinchannel/'.$company_detail->seo_url)); ?>" data-offset="30">Vide Call</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row wow fadeIn" data-wow-delay="0.4s" id="introduction">
                        <div class="col-lg-12">
                            <div class="divider-new">
                                <h2 class="h2-responsive">Welcome to <?php echo e($company_detail->company_name); ?></h2>
                            </div>
                            ...
                            <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item active">
                                        <img src="<?php echo e(asset( 'image/'.$company_detail->banner_file)); ?>" alt="First slide" class="img-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <iframe id="vid_frame" src="http://www.youtube.com/embed/<?php echo e($company_detail->intro_video); ?>/?modestbranding=1&;showinfo=0&;autohide=1&;rel=0;" frameborder="0" width="560" height="365" allowfullscreen ></iframe>
                        </div>
                        <div class="col-md-2" id="vsidebar">
                            <div class="card" id="scrollvideo">
                                ...
                                <div class="vid-item" onClick="document.getElementById('vid_frame').src='http://youtube.com/embed/<?php echo e($video->link); ?>/?modestbranding=1&;showinfo=0&;autohide=1&;rel=0;'">
                                    <div class="thumb"><img src="http://img.youtube.com/vi/<?php echo e($video->link); ?>/0.jpg" width="150" height="150"></div>
                                        <div class="desc">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card wow fadeIn" data-wow-delay="0.2s" id="gallery">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="<?php echo e(asset( 'image/'.$photo->image )); ?>" alt="Card image cap">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--Text-->
                                    <p class="card-text"><?php echo e($photo->description); ?>
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/front/enroll/test.blade.php ENDPATH**/ ?>