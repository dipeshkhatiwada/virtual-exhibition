                                    ...
                                    <div class="col-xs-12 table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="<?php echo e(url('employee/invoice/view/'.$job->id)); ?>" class="btn whitegradient blueclr"><i class="fa fa-eye"></i> View</a>
                                                    <!-- <a href="javascript:void(0);" onClick="confirm_delete('/<?php echo e($job->id); ?>')" class="btn whitegradient greenclr left redclr"><i class="fa fa-trash-alt"></i> Delete</a> -->
                                                </td>
                                            </tr>
...
//       var url= "<?php echo e(url('/employee/invoice/delete/')); ?>"+ids;
//       location = url;
//       }
//     }
</script>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/facybox/myfunction.js?v=2.1.5')); ?>" ></script>
  </html><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employee/invoice.blade.php ENDPATH**/ ?>