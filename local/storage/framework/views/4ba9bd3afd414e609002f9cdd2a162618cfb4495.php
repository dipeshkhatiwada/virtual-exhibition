  ...
  <div class="container">
    <div class="row cm-row">
      <div class="col-lg-2 col-md-2 col-3 inner_logo hidden-xs">
        <a href="<?php echo e(url('/tenders')); ?>"><img src="<?php echo e(\App\library\Settings::getTenderLogo()); ?>"></a>
      </div>
...
</header><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/front/common/tender_header.blade.php ENDPATH**/ ?>