...
<div class="Application">
    <div class="AppLeft"> <img src="<?php echo e(asset('rollingnexus/image/'.$data['logo'])); ?>" height="75px" width="224">
        <div class="thinLine"> </div>
        <div class="salutation" >
            <p id="lin"> Dear, <?php echo e($data['to_name']); ?> </p>
        </div>   <!-- start/end of links-->
        <div class="message" >
             <p id="lin2">We are pleased to inform you about the upcoming exhibition scheduled for <?php echo e(Carbon\Carbon::parse($data['reserve']->start_date)->toFormattedDateString('d-m-Y')); ?>.
                    Please prepare with the requirement for the virtual exhibition. <br><br> If you have any question, feel free to get in touch
        ...
        <div class="regards" >
            <p id="lin2"> Regards,  </p>
            <p id="lin"> Rolling Nexus </p> <p id="lin"> 9801365247 </p>  </div>   <!-- start/end of links-->
    </div>
    <div class="AppRight" >
        <h2>Application Confirmation </h2>
        <div class="ronnie"> <img src="<?php echo e(asset('rollingnexus/images/ronnie.png')); ?>" height="100px"> </div>
        <div class="eventLogo"> <img src="<?php echo e(asset('rollingnexus/images/event.png')); ?>" height="100px"> </div>
    </div>

</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/mail/enroll_reminder.blade.php ENDPATH**/ ?>