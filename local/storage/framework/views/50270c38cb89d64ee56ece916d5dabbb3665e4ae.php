...
<body class="agora-theme">
  <div class="navbar-fixed">
    <nav class="agora-navbar">
      <div class="nav-wrapper agora-primary-bg valign-wrapper">
        ...
        <a href="https://github.com/AgoraIO/Basic-Video-Call/tree/master/One-to-One-Video/Agora-Web-Tutorial-1to1" class="agora-github-pin">ss</a>
      </div>
    </nav>
  </div>
        ...
        <div class="card" style="margin-top: 0px; margin-bottom: 0px;">
          <div class="row card-content" style="margin-bottom: 0px;">
              <div class="input-field">
                ...
                <input type="hidden" placeholder="App ID" name="appID" value="fc2e17576a5247679108661a0ef3e7dc">
                <input type="text" value="fc2e17576a5247679108661a0ef3e7dc">
              </div>
              <div class="input-field">
                <label for="channel" class="active">Channel</label>
                <input type="text" placeholder="channel" name="channel" value="<?php echo e($data['channel']); ?>">
              </div>
              <div class="input-field">
                <label for="token" class="active">Token</label>
                <input type="text" placeholder="token" name="token" value="<?php echo e($data['token']); ?>">
              </div>
              ...
              <div class="row">
                <div class="col s12">
                  <div class="input-field">
                    ...
                    <input type="number" placeholder="UID" name="uid" value="<?php echo e($data['uid']); ?>">
                  </div>
                  <div class="input-field">
  ...
  <script src="<?php echo e(asset('js/AgoraRTCSDK-3.1.2.js')); ?>"></script>
  <script>
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/enroll/agora-test.blade.php ENDPATH**/ ?>