				...
				<div class="modal-content">
					...
					<div class="modal-body mx-3">
						<div class="md-form mb-5">
                            ...
                            <input type="hidden" id="reservation" class="form-control" value="<?php echo e($datas['enroll']->id); ?>" disabled>
                            <input type="hidden" id="pusher_key" value="<?php echo e('6e2167f314296786dc0a'); ?>">

                        </div>

						<div class="md-form mb-4">
                        <input type="text" id="form-channel" class="form-control" value="<?php echo e($datas['set_channel']); ?>-videocall" disabled>
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/enroll/videocall.blade.php ENDPATH**/ ?>