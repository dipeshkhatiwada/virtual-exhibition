      ...
      <div class="row cm10-row">
        ...
        <div class="<?php echo e($class); ?>">
          <div class="trainingblock">
            <?php if(isset($datas['event']->id)): ?>
            <?php if(!empty($datas['image'])): ?>
            <div class="row cm10-row">
              <img src="<?php echo e(asset($datas['image'])); ?>" style="width: 30%; margin-left:auto;margin-right:auto;">
            </div>
            <?php endif; ?>
            <div class="row cm10-row">
              <div class="tb20p">
                <h2 class="title_two btm7m"><?php echo e($datas['event']->title); ?></h2>
                <div class="title_three">Description
                  <?php if($datas['event']->ticket_type == 1): ?>
                    <span class="badge badge-primary">Free Event</span>
                  <?php endif; ?>
                  <?php if($datas['event']->ticket_type == 2): ?>
                    <span class="badge badge-primary">NRS. <?php echo e($datas['event']->price); ?></span>
                  <?php endif; ?>
                  <?php if($datas['event']->ticket_type == 3): ?>
                    <table class="table table-bordered" id="tickettable">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $datas['event']['eventTicketType']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                ...
                <div class="title_three btm15m">Organizer : <a href="<?php echo e(url('/events/business/'.\App\Employers::getUrl($datas['event']->employers_id))); ?>" class="blueclr italic"><?php echo e(\App\Employers::getName($datas['event']->employers_id)); ?></a></div>

                <div class="title_three btm15m">Event Category : <a href="<?php echo e(url('/events/category/'.\App\EventCategory::getUrl($datas['event']->event_category_id))); ?>" class="blueclr italic"><?php echo e($datas['event_category']); ?></a></div>
                <div class="event_info">
                  <p><i class="fa fa-landmark"></i> <?php echo e($datas['event']->venue); ?></p>
                  <p><i class="fa fa-map-marker-alt"></i> <?php echo e($datas['event']->address); ?></p>
                  <p><i class="far fa-calendar-alt"></i> <?php echo e($datas['event']->event_date); ?></p>

                </div>
                <?php if(count($datas['event']->Sponsors) > 0): ?>
                <h5 class="title_three tp20p">SPONSORED BY:</h5>
                <div class="sponsors">
                  <?php $__currentLoopData = $datas['event']->sponsors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if(is_file(DIR_IMAGE.$sponsors->logo)): ?>
                  <?php ($image = \App\Imagetool::mycrop($sponsors->logo,200,200)); ?>
                  <div class="col-lg-1 col-md-2 col-sm-4 col-6" >
                    <?php if($sponsors->url != ''): ?>
                    <a href="<?php echo e($sponsors->url); ?>" target="_blank"><img src="<?php echo e(asset($image)); ?>" style="width: 100% !important;"></a>
                    <?php else: ?>
                    <img src="<?php echo e(asset($image)); ?>" style="width: 100% !important">
                    <?php endif; ?>
                  </div>
                  <?php endif; ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
                <div class="tp20m">
                  <?php if($datas['event']->event_type == 1): ?>
                    <?php if($datas['event']->ticket_type == 1): ?>
                      <?php if(isset(Auth::guard('employee')->user()->firstname)): ?>
                        <?php if($datas['event']->event_reserved): ?>
                          <?php if($datas['event']->event_date." ".$datas['event']->start_time <= $datas['event']->current_dt &&
                            $datas['event']->to_date." ".$datas['event']->end_time >= $datas['event']->current_dt): ?>
                            <a href="<?php echo e($datas['event']->eventMeeting->join_url); ?>" target="_blank" class="btn lightgreen_gradient">Participate Now</a>
                          <?php elseif($datas['event']->event_date." ".$datas['event']->start_time > $datas['event']->current_dt): ?>
                            <div class="alert alert-info">
                              <strong>Success!</strong> Your payment is Successful. The meeting will start at <?php echo e($datas['event']->event_date); ?> <?php echo e($datas['event']->start_time); ?>.
                            </div>
                          <?php elseif($datas['event']->to_date." ".$datas['event']->end_time < $datas['event']->current_dt): ?>
                            <div class="alert alert-danger">
                              <strong>The event was held on <?php echo e($datas['event']->event_date); ?>.</strong>
                            </div>
                          <?php endif; ?>
                        <?php else: ?>
                          <?php if($datas['event']->participants_limit == 1): ?>
                            <a class="btn lightgreen_gradient" event-id="<?php echo e($datas['event']->id); ?>" id="book-inhouse-event-ticket"><i class='fas fa-cart-plus'></i> Book</a>
                          <?php else: ?>
                            <!-- check if the seats are available -->
                            <?php if(count($datas['event']->eventReservation) < $datas['event']->participants_max_limit): ?>
                      ...
                      <?php endif; ?>
                    <?php elseif($datas['event']->ticket_type == 2 || $datas['event']->ticket_type == 3): ?>
                      <?php if(isset(Auth::guard('employee')->user()->firstname)): ?>
                        <!-- check if there participant limit -->
                        <?php if($datas['event']->event_reserved): ?>
                            <?php if($datas['event']->invoice_status == 'Complete'): ?>
                              <?php if($datas['event']->event_date." ".$datas['event']->start_time <= $datas['event']->current_dt &&
                                $datas['event']->to_date." ".$datas['event']->end_time >= $datas['event']->current_dt): ?>
                                <a href="<?php echo e($datas['event']->eventMeeting->join_url); ?>" target="_blank" class="btn lightgreen_gradient">Participate Now</a>
                              <?php elseif($datas['event']->event_date." ".$datas['event']->start_time > $datas['event']->current_dt): ?>
                        ...
                        <?php else: ?>
                          <?php if($datas['event']->participants_limit == 1): ?>
                            <?php if(count($datas['event']['eventTicketType']) > 0): ?>
                              <label for="ticket_type">Choose Ticket Type:</label>
                              <select name="ticket_type" id="ticket_type">
                                <?php $__currentLoopData = $datas['event']['eventTicketType']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option price="<?php echo e($ticket->price); ?>" value="<?php echo e($ticket->id); ?>"><?php echo e($ticket->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            <?php endif; ?>
                            <a class="btn lightgreen_gradient" event-id="<?php echo e($datas['event']->id); ?>" id="buy-inhouse-event-ticket"><i class='fas fa-cart-plus'></i>Buy</a>
                          <?php else: ?>
                            <!-- check if the seats are available -->
                            <?php if(count($datas['event']->eventReservation) < $datas['event']->participants_max_limit): ?>
                              <!-- booking/payment process -->
                      ...
                      <?php endif; ?>
                    <?php endif; ?>
                  <?php elseif($datas['event']->event_type == 2): ?>
                    <?php if($datas['event']->ticket_type == 1): ?>
                    <?php elseif($datas['event']->ticket_type == 2 || $datas['event']->ticket_type == 3): ?>
                      <?php if(isset(Auth::guard('employee')->user()->firstname)): ?>
                        <?php if($datas['event']->participants_limit == 1): ?>
                          ...
                          <a class="btn lightgreen_gradient" target="_blank" event-id="<?php echo e($datas['event']->id); ?>" id="buy-outsource-event-ticket"><i class='fas fa-cart-plus'></i> Buy</a>
                        <?php else: ?>
                          <!-- check if the seats are available -->
                          <?php if(count($datas['event']->eventReservation) < $datas['event']->participants_max_limit): ?>
                            <!-- booking/payment process -->
                            ...
                            <label for="quantity">Quantity</label>
                            <input type="number" name="quantity" id="quantity" value="1">
                            <a class="btn lightgreen_gradient" event-id="<?php echo e($datas['event']->id); ?>" id="buy-outsource-event-ticket"><i class='fas fa-cart-plus'></i> Buy</a>
                            <!-- booking/payment process -->
                          <?php else: ?>
                            <div class="alert alert-danger">
                              <strong>Sorry!</strong> All the Seats have been taken.
              ...
              <div class="tab-content stroke" id="nav-tabContent">
                            ...
                            <div class="container">
                              <div class="col-md-12" id="fbcomment">
                                ...
                                <div class="body_comment">
                                  <?php if(Auth::guard('employee')->check() || Auth::guard('employee')->check()): ?>
                                  ...
                                  <div class="row">
                                    <ul id="list_comment" class="col-md-12">
                                      <?php $__currentLoopData = $datas['event']['comment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($comment->parent_id == null): ?>
                                          <li class="box_result row">
                                            ...
                                            <div class="result_comment col-md-11">
                                              <h4>
                                                <?php echo e($comment->employee != null ? $comment->employee->firstname.' '.$comment->employee->lastname:''); ?>

                                                <?php echo e($comment->employer != null ? $comment->employer->firstname.' '.$comment->employer->lastname:''); ?>
                                              ...
                                              <div class="tools_comment">
                                                ...
                                                <?php if(Auth::guard('employee')->check() || Auth::guard('employee')->check()): ?>
                                                  <a class="replay" href="" comment_id="<?php echo e($comment->id); ?>">Reply</a>
                                                  <!-- <span aria-hidden="true"> · </span> -->
                                                  <!-- <i class="fa fa-thumbs-o-up"></i> <span class="count">1</span>  -->
                                                  <span aria-hidden="true"> · </span>
                                                <?php endif; ?>
                                                <span><?php echo e(\Carbon\Carbon::createFromTimeStamp(strtotime($comment->created_at))->diffForHumans()); ?></span>
                                              </div>
                                                ...
                                                <?php if($comment->replies!= null): ?>
                                                  <?php $__currentLoopData = $comment->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="box_reply row">
                                                      ...
                                                      <div class="result_comment col-md-11">
                                                        <h4>
                                                          <?php echo e($reply->employee != null ? $reply->employee->firstname.' '.$reply->employee->lastname:''); ?>

                                                          <?php echo e($reply->employer != null ? $reply->employer->firstname.' '.$reply->employer->lastname:''); ?>
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                  ...
                  <div class="container">
                                ...
                                <div class="card bg-light card-body mb-3 card bg-faded">
                                    <div class="row">
                                        <div class="col-12 col-lg-6 text-center">
                                            <h1 class="rating-num">
                                            <?php echo e(number_format($datas['event']['avgRatings'], 1)); ?>

                                            </h1>
                                              <div class="row">
                                              <fieldset class="col-md-12 rating" style="padding-right:240px">
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=5 && $datas['event']['avgRatings']>4.5 )   ? 'checked': ''); ?>  id="avgStar5" name="rating" value="5" /><label class = "full" for="avgStar5" title="Awesome - 5 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=4.5 && $datas['event']['avgRatings']>4 )   ? 'checked': ''); ?>  id="avgStar4half" name="rating" value="4 and a half" /><label class="half" for="avgStar4half" title="Pretty good - 4.5 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=4 && $datas['event']['avgRatings']>3.5 )   ? 'checked': ''); ?>  id="avgStar4" name="rating" value="4" /><label class = "full" for="avgStar4" title="Pretty good - 4 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=3.5 && $datas['event']['avgRatings']>3 )   ? 'checked': ''); ?>  id="avgStar3half" name="rating" value="3 and a half" /><label class="half" for="avgStar3half" title="Meh - 3.5 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=3 && $datas['event']['avgRatings']>2.5 )   ? 'checked': ''); ?>  id="avgStar3" name="rating" value="3" /><label class = "full" for="avgStar3" title="Meh - 3 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=2.5 && $datas['event']['avgRatings']>2 )   ? 'checked': ''); ?>  id="avgStar2half" name="rating" value="2 and a half" /><label class="half" for="avgStar2half" title="Kinda bad - 2.5 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=2 && $datas['event']['avgRatings']>1.5 )   ? 'checked': ''); ?>  id="avgStar2" name="rating" value="2" /><label class = "full" for="avgStar2" title="Kinda bad - 2 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=1.5 && $datas['event']['avgRatings']>1 )   ? 'checked': ''); ?>  id="avgStar1half" name="rating" value="1 and a half" /><label class="half" for="avgStar1half" title="Meh - 1.5 stars"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=1 && $datas['event']['avgRatings']>0.5 )   ? 'checked': ''); ?>  id="avgStar1" name="rating" value="1" /><label class = "full" for="avgStar1" title="Sucks big time - 1 star"></label>
                                                  <input type="radio" disabled  <?php echo e(($datas['event']['avgRatings']<=0.5 && $datas['event']['avgRatings']>0 )   ? 'checked': ''); ?>  id="avgStarhalf" name="rating" value="half" /><label class="half" for="avgStarhalf" title="Sucks big time - 0.5 stars"></label>
                                              </fieldset>
                                              <div class="col-md-12">
                                                <span class="glyphicon glyphicon-user"></span><?php echo e(count($datas['event']->reviews)); ?> total
                                              </div>
                                            </div>
                                        </div>
                    ...
                    <?php $__currentLoopData = $datas['event']->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="container">
                        <div class="row card">
                            <div class="card bg-light card-body card bg-faded">
                                <div class="row">
                                    <!-- <div class="col-md-2">
                                      ...
                                      <div class="col-md-12">
                                        <p>
                                          <a class="float-left" href="">
                                            <strong>
                                            <?php echo e($review->employee != null ? $review->employee->firstname.' '.$review->employee->lastname:''); ?>

                                            <?php echo e($review->employer != null ? $review->employer->firstname.' '.$review->employer->lastname:''); ?>
                                      ...
                                      <p class="text-secondary"><?php echo e(\Carbon\Carbon::createFromTimeStamp(strtotime($review->created_at))->diffForHumans()); ?></p>
                                    </div>
            ...
            <?php if(count($datas['event']->Photos) > 0 || $datas['event']->video != ''): ?>
            <div class="tabsection">
              <nav>
                <div class="nav nav-tabs event_tab" id="nav-tab"  role="tablist" >
              ...
              <div class="tab-content stroke" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-comment" role="tabpanel" aria-labelledby="nav-comment-tab">
                  <div class="event_gallery">
                    <div class="row cm10-row">
                      <?php if(count($datas['event']->Photos) > 0): ?>
                      <?php $__currentLoopData = $datas['event']->Photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if(is_file(DIR_IMAGE.$photo->image)): ?>
                      <?php ($event_photo = \App\Imagetool::mycrop($photo->image,400,225)); ?>
                      <div class="col-md-2">
                        <img src="<?php echo e(asset($event_photo)); ?>" class="rgt8m img_size">
                      </div>
                      <?php endif; ?>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php else: ?>
                ...
                <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                  ...
                  <div class="event_gallery">
                    <div class="row cm10-row">
                      <div class="col-md-12">
                        <?php if(!empty($datas['event']->video)): ?>
...
<?php if(count($datas['bottom_content']) > 0 || count($datas['related']) > 0): ?>
<section id="bottom_content" class="jobs tb35p">
  <div class="container">
    <div class="white_div">
      <div class="tp20p">
        <?php if(count($datas['related']) > 0): ?>
        <?php $__currentLoopData = $datas['related']->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row cm10-row">
          ...
          <div class="col-md-4">
            <div class="white_block event">
              ...
              <h3 class="h3"><?php echo e($event->title); ?></h3>
              <div class="border"></div>
              <p><?php echo e(\App\Library\Settings::getLimitedWords($event->description,0,20)); ?></p>
              <div class="event_info">
                <p><i class="fa fa-map-marker-alt"></i> <?php echo e($event->address); ?></p>
                <p><i class="fa fa-landmark"></i> <?php echo e($event->venue); ?></p>
                <p><i class="far fa-calendar-alt"></i> <?php echo e($event->event_date); ?></p>
              </div>
              <div class="tp10p">
                <a href="<?php echo e(url('/events/'.$event->seo_url)); ?>" class="morejob">More <i class="fa fa-angle-double-right"></i></a>
              </div>
            </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    $("#share").on("click", function(){
      var event_id = "<?php echo e($datas['event']->id); ?>";
      var token = $('input[name=\'_token\']').val();
...
<?php echo $__env->make('front.event-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/front/event/eventdetails.blade.php ENDPATH**/ ?>