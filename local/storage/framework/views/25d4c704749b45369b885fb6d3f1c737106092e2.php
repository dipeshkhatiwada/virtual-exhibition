<div class="chat-main" id="chat_main_<?php echo e($data['user_id']); ?>">
    <div class="col-md-12 chat-header-business rounded-top text-white" id="header_<?php echo e($data['user_id']); ?>">
        <div class="row">
    ...
    <div class="chat-content" id="chat_content<?php echo e($data['user_id']); ?>">
        ...
        <div class="message-box-for-participate chat_border pl-2 pr-2 border-top-0">
...
.message-box-for-participate{
  width: 100%;
  background: #FFFFFF;
}
.message-box-for-participate textarea{
    border: none !important;
    font-size: 13px;
    opacity: 0.7;
}
.message-box-for-participate textarea:focus{
    outline: none;
}
.message-box-for-participate .tools{
      display: flex;
      position: relative;
}
.tools i{
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/front/enroll/messages/chat_box.blade.php ENDPATH**/ ?>