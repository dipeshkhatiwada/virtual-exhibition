				...
				<div class="modal-content">
					...
					<div class="modal-body mx-3">
						<div class="md-form mb-5">
							<input type="text" id="form-appid" value="b5189aeef84949959a7700b419bed954" class="form-control">
							<label for="form-appid">Agora AppId</label>
						</div>

						<div class="md-form mb-4">
                        <input type="text" id="form-channel" class="form-control" value="<?php echo e($data['channel']); ?>">
...
<?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/enroll/broad.blade.php ENDPATH**/ ?>