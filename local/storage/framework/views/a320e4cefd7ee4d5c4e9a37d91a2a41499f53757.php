        ...
        <form class="dash_forms" enctype="multipart/form-data" role="form" id="testform" method="POST" action="<?php echo e(route('enroll.addnew')); ?>">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="mainenroll" role="tabpanel" aria-labelledby="enroll-tab">
                    ...
                    <div class="form-group row <?php echo e($errors->has('banner_image') ? ' has-error' : ''); ?> ">
                        <div class="col-md-6">
                            <label class="required">Banner File Upload (High Quality)</label>
                            <input type="file" class="form-control" name="banner_image" id="banner_image" accept="image/x-png,image/gif,image/jpeg" />
...
<?php echo $__env->make('employer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/enroll/enrolltest.blade.php ENDPATH**/ ?>