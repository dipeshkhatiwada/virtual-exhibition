			...
			<div class="container-fluid p-0">
				...
				<div id="main-container">
					...
					<div id="buttons-container" class="row justify-content-center mt-3">
						...
						<div class="col-md-2 text-center btn-group">
							<button id="finish-broadcast" class="btn btn-raised btn-danger waves-effect waves-light">
                                Stop Streaming
                            </button>
                        </div>
...
<?php echo $__env->make('employer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/employer/enroll/broadcast_live.blade.php ENDPATH**/ ?>