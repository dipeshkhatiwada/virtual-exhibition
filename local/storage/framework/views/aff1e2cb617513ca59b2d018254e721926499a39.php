        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="panel panel-default">
                    <div class="panel-heading">New Virtual Exhibition Type</div>
                                            ...
                                            <form class="dash_forms" enctype="multipart/form-data" role="form" id="testform" method="POST" action="<?php echo e(route('enroll_type.save')); ?>">
                                                ...
                                                <div class="form-group row <?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" id="vtype"  name="vtype" class="form-control" placeholder="Exhibition Type">
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rollingnexus\local\resources\views/admin/enroll/new_create.blade.php ENDPATH**/ ?>