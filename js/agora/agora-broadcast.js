...
var channelName = $('#company-channel').val(); // set channel name
...
$(document).ready(function() {  
    ...
    $("#start_stream").on("click", function (e) {
       ...
       client.init(
        ...
        function() {
          $.ajax({
            ...
            url: base_url + '/employer/enroll/livestream/'+channelName + '/store-stime',
            data:{
              'channel': channelName
            },
            cache:false,
...
$("#finish-broadcast").click(function(){
  ...
  client.leave(
    function() {
      ...
      $.ajax({
        type:'post',
        headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
        url: base_url + '/employer/enroll/livestream/'+channelName + '/store-etime',
        data:{
          'channel': channelName
        },
        cache:false,
      ...
      $("#stop-broadcast").prop("disabled", true);
